...
// 判断点是否在圆内
bool PointInCircle(double pointX, double pointY, double circleCenterX, double circleCenterY, double circleRadius) {
...
// 判断两个圆是否相交
bool CirclesIntersect(double circleCenterX1, double circleCenterY1, double circleRadius1, double circleCenterX2, double circleCenterY2, double circleRadius2) {
...
// 判断点是否在圆环内
bool PointInAnnulus(double x, double y, double circleCenterX, double circleCenterY, double circleRadius, double innerThickness, double outerThickness) {
    // 计算点到圆心的距离
...
// 判断点是否在椭圆内
bool PointInEllipse(double centerX, double centerY, double radiusA, double radiusB, double x, double y) {
